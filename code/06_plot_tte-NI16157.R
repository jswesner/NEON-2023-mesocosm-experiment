...
simulated_tte_plot = sim_te %>% 
  ...
  labs(y = "Trophic Transfer Efficiency",
       ...
       Assuming that plausible TTE's range from 0.05 to 0.2, only a small fraction of parameter values result in plausible TTEs.
       Moreover under empirical values of \u03bb (vertical shaded lines), no combination of parameter values lead to plausible TTEs") +
  guides(alpha = "none") +
